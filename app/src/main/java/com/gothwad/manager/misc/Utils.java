...
public class Utils extends UtilsFlavour{
    ...
    public static void changeThemeStyle(AppCompatDelegate delegate) {
        try {
            ...
            try {
                nightMode = Integer.parseInt(SettingsActivity.getThemeStyle());
    ...
    public static void openFeedback(Activity activity){
        ShareCompat.IntentBuilder
                ...
                .setSubject("Gothwad Manager Feedback" + getSuffix())
                .setType("text/email")
    ...
    public static Intent registerReceiver(Context context, android.content.BroadcastReceiver receiver, IntentFilter filter, boolean exported) {
