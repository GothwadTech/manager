...
package com.gothwad.manager.setting;
...
import com.gothwad.manager.common.AppCompatPreferenceActivity;
import com.gothwad.manager.common.SettingsCommonActivity;
import com.gothwad.manager.misc.AnalyticsManager;
import com.gothwad.manager.misc.CrashReportingManager;
import com.gothwad.manager.misc.PreferenceUtils;
...
public class SettingsActivity extends SettingsCommonActivity {
    ...
    public static boolean getDisplayRecentMedia() {
        Context context = DocumentsApplication.getInstance();
        if (context == null) {
            return !isWatch();
        }
        return PreferenceManager.getDefaultSharedPreferences(context)
    ...
    public static int getPrimaryColor(Context context) {
        if (context == null) return Color.parseColor("#0288D1");
    ...
    public static int getAccentColor() {
        Context context = DocumentsApplication.getInstance();
        if (context == null) {
            return Color.parseColor("#EF3A0F");
        }
        return PreferenceManager.getDefaultSharedPreferences(context)
