...
import static com.gothwad.manager.misc.ConnectionUtils.ACTION_FTPSERVER_FAILEDTOSTART;
...
import static com.gothwad.manager.misc.Utils.isWatch;
...
public class ServerFragment extends Fragment implements View.OnClickListener {
    ...
    public void onResume(){
        ...
        Utils.registerReceiver(getActivity(), mWifiReceiver, wifiFilter, true);
        ...
        Utils.registerReceiver(getActivity(), mFtpReceiver, ftpFilter, false);
    }
