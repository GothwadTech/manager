...
import com.gothwad.manager.misc.ColorUtils;
...
import static com.gothwad.manager.DocumentsActivity.getStatusBarHeight;
import static com.gothwad.manager.misc.Utils.getSuffix;
import static com.gothwad.manager.misc.Utils.openFeedback;
import static com.gothwad.manager.misc.Utils.openPlaystore;
...
public class AboutActivity extends AboutFlavour implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(view instanceof Toolbar){
			...
			mToolbar.setTitleTextAppearance(this, androidx.appcompat.R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
			if(Utils.hasKitKat() && !Utils.hasLollipop()) {
		...
		switch (view.getId()) {
			...
			case R.id.action_share:
				...
				ShareCompat.IntentBuilder
						...
						.setText(shareText)
						.setType("text/plain")
						.setChooserTitle("Share Gothwad Manager")
						.startChooser();
