...
import com.gothwad.manager.usb.UsbUtils;
...
import static com.gothwad.manager.misc.FileUtils.getTypeForName;
import static com.gothwad.manager.misc.MimeTypes.BASIC_MIME_TYPE;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "com.gothwad.manager.action.USB_PERMISSION";
    ...
    public boolean onCreate() {
        ...
        Utils.registerReceiver(context, mUsbReceiver, filter, true);
...
/*            final int accessMode = ParcelFileDescriptorUtil.parseMode(mode);
    ...
    public void requestPermission(UsbDevice device){
        PendingIntent permissionIntent = PendingIntent.getBroadcast(getContext(), 0, new Intent(
                ACTION_USB_PERMISSION), Utils.getPendingIntentFlags(0));
