...
import com.gothwad.filemanager.misc.ImageUtils;
import com.gothwad.filemanager.misc.OsCompat;
import com.gothwad.filemanager.misc.Utils;
import com.gothwad.filemanager.provider.DocumentsProvider;
import com.gothwad.filemanager.provider.UsbStorageProvider;

import static com.gothwad.filemanager.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "com.gothwad.filemanager.action.DOCUMENTS_PROVIDER";
     ...
     * {@link com.gothwad.filemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link com.gothwad.filemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link com.gothwad.filemanager.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link com.gothwad.filemanager.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link com.gothwad.filemanager.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link com.gothwad.filemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link com.gothwad.filemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
