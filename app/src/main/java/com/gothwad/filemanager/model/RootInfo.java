...
import com.gothwad.filemanager.provider.DownloadStorageProvider;
...
import com.gothwad.filemanager.provider.MediaDocumentsProvider;
import com.gothwad.filemanager.provider.NonMediaDocumentsProvider;
import com.gothwad.filemanager.provider.RecentsProvider;
import com.gothwad.filemanager.provider.RootedStorageProvider;
import com.gothwad.filemanager.provider.UsbStorageProvider;
...
import static com.gothwad.filemanager.model.DocumentInfo.getCursorLong;
...
/*    public boolean isHome() {
    ...
    public Drawable loadToolbarIcon(Context context) {
        if (derivedIcon != 0) {
            return IconUtils.applyTintAttr(context, derivedIcon, androidx.appcompat.R.attr.colorControlNormal);
        } else {
            return IconUtils.loadPackageIcon(context, authority, icon);
        }
    }
