...
package com.gothwad.filemanager.provider;
...
import com.gothwad.filemanager.libcore.util.Objects;
...
import com.gothwad.filemanager.model.DocumentsContract.Root;

import static androidx.core.app.AppOpsManagerCompat.MODE_ALLOWED;
import static com.gothwad.filemanager.model.DocumentsContract.EXTRA_INFO;
import static com.gothwad.filemanager.model.DocumentsContract.METHOD_COMPRESS_DOCUMENT;
import static com.gothwad.filemanager.model.DocumentsContract.METHOD_COPY_DOCUMENT;
import static com.gothwad.filemanager.model.DocumentsContract.METHOD_CREATE_DOCUMENT;
import static com.gothwad.filemanager.model.DocumentsContract.METHOD_DELETE_DOCUMENT;
import static com.gothwad.filemanager.model.DocumentsContract.METHOD_IS_CHILD_DOCUMENT;
import static com.gothwad.filemanager.model.DocumentsContract.METHOD_MOVE_DOCUMENT;
import static com.gothwad.filemanager.model.DocumentsContract.METHOD_REMOVE_DOCUMENT;
import static com.gothwad.filemanager.model.DocumentsContract.METHOD_RENAME_DOCUMENT;
import static com.gothwad.filemanager.model.DocumentsContract.METHOD_UNCOMPRESS_DOCUMENT;
import static com.gothwad.filemanager.model.DocumentsContract.METHOD_UPLOAD_DOCUMENT;
import static com.gothwad.filemanager.model.DocumentsContract.buildDocumentUri;
import static com.gothwad.filemanager.model.DocumentsContract.buildDocumentUriMaybeUsingTree;
import static com.gothwad.filemanager.model.DocumentsContract.buildTreeDocumentUri;
import static com.gothwad.filemanager.model.DocumentsContract.getDocumentId;
import static com.gothwad.filemanager.model.DocumentsContract.getRootId;
import static com.gothwad.filemanager.model.DocumentsContract.getSearchDocumentsQuery;
import static com.gothwad.filemanager.model.DocumentsContract.getTreeDocumentId;
import static com.gothwad.filemanager.model.DocumentsContract.isTreeUri;
import static com.gothwad.filemanager.model.DocumentsContract.uploadDocument;
...
public abstract class DocumentsProvider extends ContentProvider {
    ...
    public void attachInfo(Context context, ProviderInfo info) {
        ...
        if (!info.exported) {
            Log.w(TAG, "Provider is not exported: " + mAuthority);
        }
        if (!info.grantUriPermissions) {
            Log.w(TAG, "Provider does not grantUriPermissions: " + mAuthority);
        }
