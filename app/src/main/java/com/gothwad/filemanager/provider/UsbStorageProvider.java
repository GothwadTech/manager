...
import com.gothwad.filemanager.usb.UsbUtils;
...
import static com.gothwad.filemanager.misc.FileUtils.getTypeForName;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "com.gothwad.filemanager.action.USB_PERMISSION";
